insert into idm_tiktok_payment.tiktok_payment_short 
select * from (
with tiktokers as (
select 
...
group by 
 ...
 select 
    ...
    youtube_premium,
    sheets_name,
    (price_count_videos + tiktok_premium + likee_premium + instagram_premium + youtube_premium) AS sum_count
 from final_short
 )
